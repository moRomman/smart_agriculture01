...
//     final uri = Uri.parse(
//         'https://web-production-7125.up.railway.app/'); // Change this to your server's address
//
...
//
//       setState(() {
//         _result1 = 'Plant Condition: ${result["Plant Condition"]}\n'
...
//     } else {
//       setState(() {
//         _result1 = 'Error: ${response.reasonPhrase}';
//       });
//     }
//   }
//
...
//                 ListTile(
//                   title: Text(
//                     'Plant Condition: ${_result2?["Plant Condition"]}\n'
//                     'Confidence Percentage: ${_result2?["Confidence Percentage"]}%',
//                     style: const TextStyle(
//                         color: Colors.black, fontWeight: FontWeight.bold),
//                     textScaler: const TextScaler.linear(1.2),
//                   ),
//                   subtitle: Text(
//                     _result2?["Plant Condition"] == 'Rust'
...
//                         : _result2?["Plant Condition"] == 'Powdery'
